...
const sections = {
  whatIsIt: makeSection(
    'What is Flight Console?',
    'what-is-it',
    'pink',
    'question',
  ),
        ...
        <Section
          ...
          <Row>
            <Col>
              ...
              <h4>Alces Flight Directory</h4>
              <p>
                Alces Flight Directory provides an easy-to-use command-line
                interface, accessible through an{' '}
                <ContextLink linkSite="Console" location="/directory">
                  embeded terminal
                </ContextLink>
                {', '}
                giving you rapid access to user, group and host management
                across your compute estate.
              </p>
            </Col>
          </Row>
          <Row>
            <Col className="d-flex justify-content-center">
              <CallToAction icon="play-circle" to="/directory">
