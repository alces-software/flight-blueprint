...
const NoTerminalServicesError = () => (
  <MissingNotice title="The Alces Flight Directory service is not configured for your organisation.">
    Your organisation has not requested access to the Alces Flight Directory
    service. Please contact your{' '}
    <SiteDashboardLink>account manager</SiteDashboardLink> if you would like to
...
const GenericLoadError = () => (
  <MissingNotice title="Unable to load directory details">
    ...
    <CommunitySiteLink>Community Support Portal</CommunitySiteLink> for further
    help.
  </MissingNotice>
);
